...
-- Inserción sobre un chunk YA comprimido (vehiculos_grande).
-- 
...
-- TIMESCALE y cambian si recreas el entorno (aquí vehiculos_grande_3001_chunk,
...
SELECT count(*) AS filas_total_grande FROM vehiculos_grande;